...
## Document
This [Document](https://docs.google.com/document/d/1ri78THWm4lE-HG7q1V8wMfJWQoHaW25s3p-ke9HhaAU/edit?usp=sharing) describes the idea behind the skill. It also explains the structure for Intents and Sample utterances as well as the different components used in the architecture of this project.
